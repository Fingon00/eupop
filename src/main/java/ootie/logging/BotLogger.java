...
import static ootie.discord.utility.DiscordErrorUtility.*;
...
public class BotLogger {
     ...
     *
     * @param message - The message associated with this log entry
     * @param err     - The error associated with this log entry. A full stack trace
     *                will be sent if this is not null
     */
    ...
    /**
     * Sends a message to #bot-log-error in offending server, else resorting to
     * #bot-log and finally webhook.
     * <p>
     * If err is not null, a full stack trace will be sent in a thread.
     * <p>
     * Assumes that the event specified in data has a guild if it exists.
    ...
    /**
     * Sends a log message via the specified bot log channel. Should be used through
     * info(), warning(), or error() methods.
     * <p>
     * Assumes that the event specified in data has a guild if it exists.
     *
     * @param origin   - The origin of the discord event that created this log entry
     * @param message  - The message associated with this log entry
     * @param err      - The error associated with this log entry. A full stack
     *                 trace will be sent if this is not null and the log is not
     *                 sent via websocket
    ...
    private static void logToChannel(
        ...
        // Handle message length overflow. Overflow length is derived from previous
        // implementation
    ...
    /**
     * Get the most relevant log channel for this source. Priority is to
     * severity.channelName, then "#bot-log", then returns null.
     *
     * @param severity - The severity of the log message, used to find the
     *                 appropriate channel based on LogSeverity.channelName
